...
#  validates_numericality_of :alto, :greater_than => 0, :message => "debe ser un número mayor que 0"
...
#  validates_numericality_of :largo, :greater_than_or_equal_to => 0, :message => "debe ser un número mayor que 0"
  validates_presence_of :ancho, :message => " no puede estar en blanco"
#  validates_numericality_of :ancho, :greater_than_or_equal_to => 0, :message => "debe ser un número mayor que 0"
  validates_presence_of :peso, :message => " no puede estar en blanco"
#  validates_numericality_of :peso, :greater_than_or_equal_to => 0, :message => "debe ser un número mayor que 0"
